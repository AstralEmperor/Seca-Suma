   <head>
        ...
        <link href="/SECA-SUMA/FrontEnd/src/Delovi/LeviMeni/leviMeni.css" type="text/css" rel="stylesheet">
   </head>
   <div class="kontejner">
        <ul class="kontejner__ul">
            <li><a href="/SECA-SUMA/FrontEnd/src/Stranice/Stampa/stampa.php">Štampa</a></li>
            <li><a href="/SECA-SUMA/FrontEnd/src/Stranice/Stampa/stampaSecaPlacenihUnapred.php">Štampa za jednu Secu</a></li>
