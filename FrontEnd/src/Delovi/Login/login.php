        ...
        <form id="login" action="/SECA-SUMA/FrontEnd/src/Modali/LoginProvera/loginProvera.php" method="POST">
            ...
            <div class="login__inputField">
                <div class="login__usernameWrap">
                    ...
                    <input id="korisnickoIme" name="korisnickoIme" type="text" placeholder="Korisnicko ime" pattern="[A-Za-z]{3,15}" oninvalid="this.setCustomValidity('Molimo vas unesite 3 do 15 slova(A-z)')" oninput="setCustomValidity('')" required>
                </div>
