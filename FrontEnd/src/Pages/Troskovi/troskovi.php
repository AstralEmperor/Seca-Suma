...
<head>
    ...
    <link href="/php-apps/SEČA-ŠUMA/FrontEnd/src/Pages/Troskovi/troskovi.css" type="text/css" rel="stylesheet">
...
<body>
    ...
    <table class="table troskovi__table">
        ...
        <tbody class="troskovi__tableBody">
            <?php  include $_SERVER['DOCUMENT_ROOT'] . "/php-apps/SEČA-ŠUMA/BackEnd/Classes/konekcijaTroskovi.php" ?>
        </tbody>
    </table>
</section>
